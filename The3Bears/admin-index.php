            ...
            <div class="col-md-9 col-lg-10 p-4 bg-white shadow-lg rounded-md">
                ...
                <div class="flex space-x-6">
                    ...
                    <div class="bg-amber-100 p-4 rounded-md shadow-md w-1/3 text-center">
                        <a href="admin-ordersb.php" class="text-decoration-none">
                    ...
                    <div class="bg-amber-100 p-4 rounded-md shadow-md w-1/3 text-center">
                        <a href="admin-reports.php" class="text-decoration-none">
                            ...
                            <h3 class="font-semibold text-xl text-black">View Reports</h3>
                            <p class="text-gray-600">Check current status of website.</p>
                        </a>
                    </div>
